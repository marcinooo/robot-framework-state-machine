...
${error_invalid_run_keyword_name}=    Run parameter should be name of keyword with main state procedure.
...
Add State to State Machine
    ...
    Add State    run=Fake State    on_update=On Update Fake State    sm=test-machine

    Run Keyword And Expect Error    ${error_invalid_state_machine_name}
    ...    Add State    run=Fake State    on_update=On Update Fake State    sm=${0}

    Run Keyword And Expect Error    ${error_invalid_run_keyword_name}
    ...    Add State    run=${0}    on_update=On Update Fake State    sm=test-machine

    Run Keyword And Expect Error    ${error_invalid_on_update_keyword_name}
    ...    Add State    run=Fake State    on_update=${0}    sm=test-machine

    Run Keyword And Expect Error    ${error_invalid_run_keyword_name}
    ...    Add State    run=${fake_list}    on_update=On Update Fake State    sm=test-machine

    Run Keyword And Expect Error    ${error_invalid_on_update_keyword_name}
    ...    Add State    run=Fake State    on_update=${fake_list}    sm=test-machine
...
Test Go To State
    ...
    ...        Add State    run=Fake State To Set Variable    on_update=On Update Fake State    sm=test-machine    AND
...
Test Update State
    [Setup]    Run Keywords
    ...        Create State Machine    name=test-machine    AND
    ...        Add State    run=Fake State    on_update=On Update Fake State To Set Variable    sm=test-machine    AND
    ...        Add State    run=Fake State To Set Variable    on_update=On Update Fake State    sm=test-machine    AND
